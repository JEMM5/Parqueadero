...
public class ReportesMensuales {
    ...
    public void GenerarReporteMensual(){
        ...
        try{
            ...
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "\\Desktop\\tiquetes\\reportesGenerados\\reporte-"+fechaBuscar+"-00.pdf")); // debe ser unico
            documento.open();
           ...
           try{
               ...
               PreparedStatement pst = cn.prepareStatement("select * from park where Fecha like '%"+fechaBuscar+"%'");
