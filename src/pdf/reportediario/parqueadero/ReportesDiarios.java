...
public class ReportesDiarios {
    ...
    public ReportesDiarios(String fechaHoy){
        this.fechaHoy = fechaHoy;
    }
    
    public void GenerarReporteComun(){
        ...
        String ruta = System.getProperty("user.home");
        PdfWriter.getInstance(documento, new FileOutputStream(ruta + "\\Desktop\\tiquetes\\reportes\\"+fechaHoy+".pdf"));
        documento.open();
        ...
        tabla.addCell("VALOR A PAGAR");
            ...
            try{
                ...
                PreparedStatement pst = cn.prepareStatement("select * from park where Fecha like '%"+fechaHoy+"%'");
