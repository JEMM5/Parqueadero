...
public class parqueaderoRegistro extends javax.swing.JFrame {
    ...
    public parqueaderoRegistro() {
        ...
        comboBox1.setBounds(129, 198, 153, 30);
        add(comboBox1);
    ...
    private void boton_generarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_generarActionPerformed
        ...
        File archivo1 = new File("C:\\Users\\JONATHAN\\Desktop\\tiquetes\\tiquete No." + nombreCambiante+".txt");
        try{
        ...
        File archivo = new File("C:\\Users\\JONATHAN\\Desktop\\tiquetes\\tiqueteNo." + nombreCambiante + ".txt");
        try{
            PrintWriter salida = new PrintWriter(new FileWriter(archivo,true));
            
            salida.println("*************************");
            salida.println("*******PARQUEADERO*******");
            salida.println("*************************");
